...
export class TenantService {
    ...
    async getCompanyByOrigin(originParam: string) {
        ...
        if (
            origin === 'oss-events-backend.vercel.app' ||
            origin === 'oss-events-frontend.vercel.app' ||
            origin.startsWith('oss-events-backend.vercel.app:') ||
            origin.startsWith('oss-events-frontend.vercel.app:') ||
            origin.includes('oss-events-backend.vercel.app') ||
            origin.includes('oss-events-frontend.vercel.app')
        ) {
