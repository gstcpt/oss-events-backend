import { IsString, IsOptional, IsDateString, IsEmail, MinLength, IsNumber } from 'class-validator';
...
export class CreateCompanyDto {
  ...
  @ApiProperty({ description: 'Company title', required: true })
  @IsString()
  @MinLength(1)
  title: string;

  @ApiProperty({ description: 'Company url', required: true })
  @IsString()
  @MinLength(8)
  url: string;
  ...
  @ApiProperty({ description: 'Company contact description', required: false })
  @IsOptional()
  @IsString()
  contact?: string;
